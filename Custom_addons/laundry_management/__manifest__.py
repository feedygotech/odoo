...
###############################################################################
{
    ...
    'data': [
        ...
        'views/snippets/laundry_service_minimal_snippet.xml',
        'views/snippets/contact_form_snippet.xml',
        'views/snippets/laundry_service_info_snippet.xml',
    ],
    'assets': {
        'web.assets_frontend': [
            'laundry_management/static/src/js/laundry_service_minimal_loader.js',
            'laundry_management/static/src/js/laundry_price_loader.js',
            'laundry_management/static/src/css/laundry_snippet.css',
            'laundry_management/static/src/js/laundry_service_info_loader.js',
            'laundry_management/static/src/css/service_info.css',
        ],
